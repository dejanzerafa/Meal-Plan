...
// Scheduled daily at 07:00 UTC — checks if today is a Christian or Muslim
// holiday and sends a branded email to all opted-in members.
//
// Holiday dates are hardcoded for 2025–2028.
// Muslim dates are approximate (depend on moon sighting — adjust ±1 day in
// HOLIDAYS config if your community observes differently).
//
// Required env vars:
...
// ── Holiday calendar (MM-DD keyed, year-specific where needed) ────────────────
const FIXED_HOLIDAYS = {
  // Christian — fixed dates
...
// Year-specific holidays (Easter moves, Muslim holidays are lunar)
const YEAR_HOLIDAYS = {
  2025: [
    // Christian
    ...
    // Muslim (approximate — based on predicted moon sighting)
    ...
    case "christmas_eve":
      return {
        ...
        html: holidayTemplate({
          ...
          note:     "Cook once. Eat all week. And have a wonderful Christmas. 🎁",
        }),
      };
    ...
    case "easter_sunday":
      return {
        ...
        html: holidayTemplate({
          ...
          note:     "Wishing you a joyful Easter surrounded by great food and great people. 🐰",
        }),
      };
    ...
    case "pentecost":
      return {
        ...
        html: holidayTemplate({
          ...
          note:     "Wishing you a blessed and energised Pentecost. 🕊️",
        }),
      };
    ...
    case "new_year":
      return {
        ...
        html: holidayTemplate({
          ...
          note:     "Wishing you an incredible year ahead. 🥂",
        }),
      };
    ...
    case "boxing_day":
      return {
        ...
        html: holidayTemplate({
          ...
          body:     `Boxing Day is all about slowing down — and maybe finishing off those Christmas leftovers 😄. When you're ready to get back on track, your meal plan is here and ready.`,
          cta:      "Plan Your Week",
          note:     "Enjoy the rest. You've earned it. 🛋️",
        }),
      };
    ...
    case "ramadan_start":
      return {
        ...
        html: holidayTemplate({
          ...
          note:     "Wishing you and your family a blessed, peaceful, and nourishing Ramadan. 🌙",
        }),
      };
    ...
    case "eid_al_fitr":
      return {
        ...
        html: holidayTemplate({
          ...
          cta:      "Explore Your Recipes",
          note:     "Taqabbal Allahu minna wa minkum — may Allah accept from us and from you. 🌙✨",
        }),
      };
    ...
    case "eid_al_adha":
      return {
        ...
        html: holidayTemplate({
          ...
          note:     "Eid Mubarak from the SoulGainz team. May Allah bless you and your family. 🕌",
        }),
      };
    ...
    case "islamic_new_year":
      return {
        ...
        html: holidayTemplate({
          ...
          note:     "Islamic New Year Mubarak from the SoulGainz team. 🌙",
        }),
      };
    ...
    case "mawlid":
      return {
        ...
        html: holidayTemplate({
          ...
          cta:      "Back to Your Meal Plan",
          note:     "Mawlid Mubarak. Peace and blessings be upon him. 🌹",
        }),
      };
    ...
    default:
      return {
        ...
        html: holidayTemplate({
          ...
          cta:      "Back to Your Meal Plan",
          note:     `Happy ${holiday.label} from all of us. 🌟`,
        }),
      };
  }
}
